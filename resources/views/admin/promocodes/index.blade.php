...
@section('title')
    <title>Kode Promo - Riverstone - Hotel & cottage - Admin Page</title>
@endsection
@section('plugins_css')
...
@section('content')
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h1 class="page-title"> Kode Promo
            <small></small>
        </h1>
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">Kode Promo</span>
            </li>
        </ul>
        <!-- END PAGE HEADER-->
        <div class="row">
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <div class="btn-group btn-group-devided" data-toggle="buttons">
                                <a href="{{ route('kode-promo.create') }}" data-toggle="modal"
                        ...
                        <ul class="pagination pagination-circle" style="margin-right: 10px">
                            <li><a href="{{ $kode_promo->url(1) }}">«</a></li>
                            @if($kode_promo->lastPage() > 1)
                                @for($i = 1; $i <= $kode_promo->lastPage(); $i++)
                                    <li><a href="{{ $kode_promo->url($i) }}">{{ $i }}</a></li>
                                @endfor
                            @endif
                            <li><a href="{{ $kode_promo->url($kode_promo->lastPage()) }}">»</a></li>
                        </ul>
                    ...
                    <div class="portlet-body">
                        <div class="table-scrollable table-scrollable-borderless">
                            <table class="table table-hover table-light">
                                ...
                                <tbody>
                                @foreach($kode_promo as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td> {{ $item->code }}</td>
                                        <td> {{ $item->reward * 100 }}%</td>
