...
<head>
    ...
    <link href="{{ asset('admin-assets/layouts/layout4/css/themes/default.min.css') }}" rel="stylesheet" type="text/css"
          id="style_color"/>
...
<div class="page-footer">
    <div class="page-footer-inner"> 2017 &copy; Riverstone Hotel & Cottage
