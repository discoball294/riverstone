...
@section('title')
    <title>Edit Layanan - Riverstone - Hotel & cottage - Admin Page</title>
@endsection
@section('plugins_css')
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> Edit Layanan</span>
                        </div>
                        <div class="actions">
                    ...
                    <div class="portlet-body form">
                        <form id="form-tambah" role="form" method="post" action="{{ route('layanan.update', $layanan->id) }}" enctype="multipart/form-data">
