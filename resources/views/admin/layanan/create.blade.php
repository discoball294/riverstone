                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> Tambah Layanan</span>
                        </div>
                        <div class="actions">
                    ...
                    <div class="portlet-body form">
                        <form id="form-tambah" role="form" method="post" action="{{ route('contact.store') }}" enctype="multipart/form-data">
