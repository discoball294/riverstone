...
<head>
    ...
    <link href="{{ asset("admin/global/components-md.min.css") }}" rel="stylesheet" id="style_components" type="text/css" />
    <link href="{{ asset("admin/global/plugins-md.min.css") }}" rel="stylesheet" type="text/css" />
    <!-- END THEME GLOBAL STYLES -->
    <!-- BEGIN PAGE LEVEL STYLES -->
    <link href="{{ asset('admin/pages/login-5.min.css') }}" rel="stylesheet" type="text/css" />
...
<script src="{{ asset('admin/pages/login-5.min.js') }}" type="text/javascript"></script>
