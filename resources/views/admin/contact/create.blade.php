    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{ route('fasilitas.index') }}">Contact</a>
                    <i class="fa fa-angle-right"></i>
                </li>
                <li>
                    <a href="#">Tambah</a>
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> Tambah Contact</span>
                        </div>
                        <div class="actions">
                    ...
                    <div class="portlet-body form">
                        <form id="form-tambah" role="form" method="post" action="{{ route('contact.store') }}">
