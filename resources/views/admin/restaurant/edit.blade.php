...
@section('title')
    <title>Restaurant - Riverstone - Hotel & cottage - Admin Page</title>
@endsection
@section('plugins_css')
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{ route('layanan.index') }}">Restaurant</a>
                    <i class="fa fa-angle-right"></i>
                </li>
                <li>
                    <a href="#">Edit</a>
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> Edit Restaurant</span>
                        </div>
                        <div class="actions">
                    ...
                    <div class="portlet-body form">
                        <form id="form-tambah" role="form" method="post" action="{{ route('restaurant.update', $restaurant->id) }}" enctype="multipart/form-data">
