                                    ...
                                    <tr>
                                        <td class="pull-left mobile-header-padding-left"
                                            ...
                                            <a href=""><img width="50%" height="50%"
                                                            src="{{ asset('img/hotel-logo.png') }}" alt="logo"></a>
                                        </td>
        ...
        <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
            <center>
                <table cellspacing="0" cellpadding="0" width="600" class="w320">
                    <tr>
                        <td class="header-lg">
                            Maaf, Reservasi anda telah dibatalkan
                        </td>
                    </tr>
                    <tr>
                        <td class="free-text">
                            Periksa kembali reservasi anda dan hubungi kami kembali
                        </td>
                    </tr>
                    <tr>
                        <td class="button">
                            <div><!--[if mso]>
                                ...
                                <![endif]--><a href="http://"
                                               style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Print Invoice</a></div>
                        </td>
                    </tr>
                    <tr>
                        <td class="w320">
                                            ...
                                            <tr>
                                                <td class="mini-block-padding">
                                                    <table cellspacing="0" cellpadding="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="mini-block">
                                                                <span class="header-sm">Booking ID</span> <br/>
                                                                #{{$reservasi->id}}
                                                                <br/>
                                                                <br/>
                                                                <br/>
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%">
                                    ...
                                    <tr>
                                        <td class="item-col item">
                                            <table cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td class="product">
                                                        <span style="color: #4d4d4d; font-weight:bold;">{{ $item->roomType->nama }}</span>
                                                        <br/>
                                                        Room Number : #{{ $item->id }}
                                                    </td>
                                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="item-col quantity"
                                        ...
                                        <span class="total-space">Unique Number</span> <br/>
                                        <span class="total-space" style="font-weight: bold; color: #4d4d4d">Total</span>
                                    </td>
                                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                                        <span class="total-space">Rp. {{ number_format($total,0,'.','.') }}</span> <br/>
                                        <span class="total-space">{{ $unik }}</span> <br/>
                                        <span class="total-space" style="font-weight:bold; color: #4d4d4d">Rp. {{ number_format($total+$unik,0,'.','.') }}</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <table cellspacing="0" cellpadding="0" width="600" class="w320">
                    <tr>
                        <td style="padding: 25px 0 25px">
                            <strong>Hotel Riverstone</strong><br/>
                            Jl K.H. Agus Salim 97 Batu <br/>
                            (0341) 524-414 <br/><br/>
                        </td>
                    </tr>
                </table>
